...
export function generateMetadata({ params }: { params: { slug: string } }) {
  ...
  return {
    title: `${post.title} | Learn To Transfer Blog`,
    description: post.excerpt,
    openGraph: {
      title: post.title,
      description: post.excerpt,
      url: `https://send-to-ph.vercel.app/blog/${post.slug}/`,
...
export default function BlogPostPage({ params }: { params: { slug: string } }) {
  ...
  const articleSchema = {
    ...
    publisher: {
      "@type": "Organization",
      name: "Learn To Transfer",
      url: "https://send-to-ph.vercel.app",
    },
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://send-to-ph.vercel.app/blog/${post.slug}/`,
    },
    tags: post.tags,
  };
